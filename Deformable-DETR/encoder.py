...
class DeformableTransformerEncoderLayer(nn.Module):
    def __init__(self, C, M, K, n_levels, last_feat_height, last_feat_width, d_ffn=2048, dropout=0.1, normalize_before=False):
        """
        Args:
        ...
        """
        super().__init__()
        self.self_attn = DeformableHeadAttention(last_height=last_feat_height,
    ...
    def forward(self, input_features, ref_points, input_masks=None, padding_masks=None, pos_encodings=None):
        ...
        if self.normalize_before:
            return self._forward_pre_norm(input_features, ref_points, input_masks, padding_masks, pos_encodings)
        return self._forward_post_norm(input_features, ref_points, input_masks, padding_masks, pos_encodings)
    
    def _forward_pre_norm(self, input_features, ref_points, input_masks=None, padding_masks=None, pos_encodings=None):
        ...
        if pos_encodings is None:
            pos_encodings = [None] * len(input_features)
    ...
    def _forward_post_norm(self, input_features, ref_points, input_masks=None, padding_masks=None, pos_encodings=None):
        if input_masks is None:
            input_masks = [None] * len(input_features)
...
class DeformableTransformerEncoder(nn.Module):
    def __init__(self, encoder_layer, num_layers, norm=None):
        """
        Args:
            - encoder_layer: an instance of the DeformableTransformerEncoderLayer() class
    ...
    def forward(self, input_features, ref_points, input_masks=None, padding_masks=None, pos_encodings=None):
        ...
        for layer in self.layers:
            output = layer(output, ref_points, input_masks=input_masks, padding_masks=padding_masks, pos_encodings=pos_encodings)
